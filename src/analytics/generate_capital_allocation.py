...
merged = cashflow.merge(profitandloss, on=["company_id", "year"], how="left")
...
for _, row in merged.iterrows():
    ...
    classification = classify_capital_allocation(cfo, cfi, cff, cfo_pat_ratio)
...
capital_allocation = pd.DataFrame(results)

capital_allocation.to_csv(OUTPUT_FILE, index=False)

print(f"Generated {OUTPUT_FILE}")

print(f"Rows: {len(capital_allocation)}")

print("\nPattern Summary:")

print(capital_allocation["pattern_label"].value_counts())
