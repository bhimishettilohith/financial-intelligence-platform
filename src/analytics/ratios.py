...
def calculate_roce(
    operating_profit, other_income, equity_capital, reserves, borrowings
):
    """
...
def calculate_high_leverage_flag(debt_to_equity, broad_sector):
    """
...
def calculate_interest_coverage(operating_profit, other_income, interest):
    ...
    return round(earnings / interest, 2)


def calculate_icr_label(icr):
    """
...
def calculate_icr_warning_flag(icr):
    """
