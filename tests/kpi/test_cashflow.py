...
def test_cfo_quality_high():
    ...
    ratio, label = calculate_cfo_quality_score(1200, 1000)
...
def test_cfo_quality_moderate():
    ...
    ratio, label = calculate_cfo_quality_score(700, 1000)
...
def test_cfo_quality_accrual_risk():
    ...
    ratio, label = calculate_cfo_quality_score(300, 1000)
...
def test_cfo_quality_pat_zero():
    ...
    ratio, label = calculate_cfo_quality_score(1000, 0)
...
def test_capex_intensity_capital_intensive():
    ...
    value, label = calculate_capex_intensity(-150, 1000)
...
def test_fcf_conversion():
    ...
    assert calculate_fcf_conversion(700, 1000) == 70.0
...
def test_shareholder_returns():
    ...
    result = classify_capital_allocation(1000, -500, -300, 1.2)
...
def test_reinvestor():
    ...
    result = classify_capital_allocation(1000, -500, -300, 0.8)
...
def test_distress_signal():
    ...
    result = classify_capital_allocation(-100, 50, 50)
...
def test_growth_funded_by_debt():
    ...
    result = classify_capital_allocation(-100, -50, 200)
...
def test_cash_accumulator():
    ...
    result = classify_capital_allocation(100, 50, 25)
