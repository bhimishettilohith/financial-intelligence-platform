...
def test_debt_to_equity_normal():
    ...
    assert calculate_debt_to_equity(1000, 200, 800) == 1.0


def test_debt_to_equity_debt_free():

    assert calculate_debt_to_equity(0, 200, 800) == 0


def test_debt_to_equity_negative_equity():

    assert calculate_debt_to_equity(1000, -500, 100) is None
...
def test_high_leverage_flag():
    ...
    assert calculate_high_leverage_flag(8, "Industrials") is True


def test_high_leverage_financials():

    assert calculate_high_leverage_flag(8, "Financials") is False
...
def test_icr_label_debt_free():
    ...
    assert calculate_icr_label(None) == "Debt Free"
